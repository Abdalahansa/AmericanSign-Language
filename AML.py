...
class Abdalahansa(torch.nn.Sequential):
...
net = Abdalahansa(n_channels=n_channels, n_classes=n_classes)
...
plot_history(history, net_name='Abdalahansa')
...
plot_metric_values(test_metric_values, df, net_name='Abdalahansa')
